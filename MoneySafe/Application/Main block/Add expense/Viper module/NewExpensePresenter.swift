...
class NewExpensePresenter: NewExpensePresenterType {
    
    var view: NewExpenseViewControllerType?
    
    var interactor: NewExpenseInteractorType?
    
    var router: NewExpenseRouterType?
