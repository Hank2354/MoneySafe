//
//  IncomeCategoriesViewController.swift
//  MoneySafe
//
...
class IncomeCategoriesViewController: UIViewController, IncomeCategoriesViewControllerType {
    ...
    var headerLabel:                       UILabel          =  {
        ...
        label.text = "Давайте выберем категории доходов"
    ...
    func update(with categories: [GeneralCategoryModel])                           {
        ...
        for index in 0..<categories.count {
            let myView = CategoryView(categoryModel: categories[index])
            ...
            myView.categoryViewType = categories[index].categoryType
